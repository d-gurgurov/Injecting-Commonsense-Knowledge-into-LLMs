...
def main():
    ...
    if data_args.line_by_line:
        ...
        dataset = load_dataset("/home/dgurgurov/commonsense_inject/lang_adapters/data", data_files=data_files)


        dataset_preprocessed = process_relationships_dataset(dataset)
        ...
        dataset_tokenized = dataset_preprocessed.map(tokenize_function, batched=True)
